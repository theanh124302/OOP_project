...
public class FestivalController extends LayoutController implements Initializable, ListPage<Festival> {
    ...
    public void getData() {
        ...
        Festival[] list;
        try {
            FileReader reader = new FileReader("Festivals.json");
    ...
    public void showList(List<Festival> festivalList) {
        ...
        try {
            for (Festival festival : festivalList) {
                ...
                fxmlLoader.setLocation(getClass().getResource("/scene/fes-item.fxml"));
    ...
    public void handleClickSearchButton(MouseEvent event) {
        ...
        for (Festival festival : festivals) {
            if (festival.getName().toLowerCase().contains(textInput.toLowerCase())) {
